    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-default">
                <form role="form" name="userForm" method="POST" action="{{ route('admin.trade.store') }}"  enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="box-body">
                        <div class="form-group @if ($errors->has('name')) has-error @endif">
                            <label>需求信息分类名称</label>
                            <input type="text" name="name" class="form-control " required oninvalid="setCustomValidity('需求信息分类名称!');"  oninput="setCustomValidity('')" placeholder="请输入需求信息分类名称" value="{{old('name')}}">
