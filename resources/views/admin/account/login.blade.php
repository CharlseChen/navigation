...
<html>
    ...
    <body class="login-page" style="background-color:#C7EDCC;">
        <div class="login-box">
            <div class="login-box-body">
                <p class="login-box-msg">{{ app_name() }} 管理后台</p>
                <form action="{{ route('admin.account.login') }}" method="post">
                    ...
                    <div style="clear:both"class="form-group has-feedback @if ($errors->first('captcha')) has-error @endif">
                        <input type="text"  style="width: 60%;display: inline-block" class="form-control" id="captcha"name="captcha" required="" placeholder="请输入验证码">
                        <a href="javascript:void(0);" id="reloadCaptcha" style="display: inline-block"><img src="{{ captcha_src()}}"></a>
