    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-default">
                <form role="form" name="userForm" method="POST" action="{{ route('admin.wx.store') }}"  enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="box-body">
                        <div class="form-group @if ($errors->has('wx_name')) has-error @endif">
                            <label>微信公众号名称</label>
                            <input type="text" name="wx_name" class="form-control " required oninvalid="setCustomValidity('必须填写微信公众号名称!');"  oninput="setCustomValidity('')" placeholder="请输入微信公众号名称" value="{{old('wx_name')}}">
                        ...
                        <div class="form-group @if ($errors->has('wx_id')) has-error @endif">
                            <label>微信公众号ID</label>
                            <input type="text" name="wx_id" class="form-control " required oninvalid="setCustomValidity('必须填写微信公众号ID!');"  oninput="setCustomValidity('')" placeholder="请输入微信公众号ID" value="{{old('wx_id')}}">
                        ...
                        <div class="form-group @if ($errors->has('wx_rank')) has-error @endif">
                            ...
                            <input type="text" name="wx_rank" class="form-control " placeholder="请输入微信号排序(数字越小排名越靠前)" value="{{old('wx_rank')}}">
