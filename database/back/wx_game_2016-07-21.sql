...
# Database: wx_game
# Generation Time: 2016-07-21 08:07:27 +0000
# ************************************************************
...
CREATE TABLE `games` (
  ...
  `must_auth` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否需要授权',
...
INSERT INTO `games` (`id`, `name`, `short_name`, `max_start_game`, `status`, `share_title`, `share_desc`, `share_img`, `must_follow`, `must_auth`, `created_at`, `updated_at`)
VALUES
	(1,'重生战场','cfzc',0,1,'重生战场','我接到了一个神秘任务，请速度前往进行挑战！！！','img/share.jpg',1,1,'2016-06-24 10:40:33','2016-07-21 09:35:04'),
	(3,'测试','test',0,0,'我要分享的标题我来','我来微信分享的描述我来微信分享的描述我来微信分享的描述我来微信分享的描述',NULL,0,1,'2016-06-24 10:47:09','2016-06-24 19:01:39'),
	(4,'自动生成器','autobuild',0,1,'','','',1,0,'2016-07-21 08:48:33','2016-07-21 09:36:43');
